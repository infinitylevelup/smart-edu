@extends('layouts.app')
@section('title', 'آزمون‌های دانش‌آموز')
    ...
    <div class="exam-page">
        ...
        <div class="exam-header mb-3 d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                ...
                <div class="subtitle">
                    اینجا آزمون‌های جدیدِ کلاس‌ها و آزمون‌های آزاد رو می‌بینی؛ شروع کن و پیشرفتت رو ثبت کن 🚀
                </div>
            </div>
        ...
        @if ($exams->count() == 0)
            <div class="alert alert-warning d-flex align-items-center gap-2 rounded-3 shadow-sm">
                ...
                فعلاً آزمونی برای شما منتشر نشده است.
            </div>
        @else
            {{-- ================= Exams Grid (CSS Grid) ================= --}}
            <div class="exam-grid">
                    ...
                    <div class="exam-card {{ $isFinalAttempt ? 'done' : '' }}">
                        ...
                        <div class="exam-body">
                            ...
                            <div class="d-flex align-items-start justify-content-between gap-2">
                                ...
                                @if ($exam->scope === 'free')
                                    <span class="badge-soft badge-dark">
                                        <i class="bi bi-globe2"></i> آزاد
                                    </span>
                                @else
                                    <span class="badge-soft badge-blue">
                                        <i class="bi bi-people-fill"></i> کلاسی
                                    </span>
                                @endif
                            </div>
                                ...
                                @switch($exam->level)
                                    @case('taghviyati')
                                        <span class="badge-soft badge-green">
                                            <i class="bi bi-lightning-fill"></i> تقویتی
                                        </span>
                                    @break

                                    @case('konkur')
                                        <span class="badge-soft badge-blue">
                                            <i class="bi bi-bullseye"></i> کنکور
                                        </span>
                                    @break

                                    @case('olympiad')
                                        <span class="badge-soft badge-amber">
                                            <i class="bi bi-award-fill"></i> المپیاد
                                        </span>
                                    @break
                                @endswitch
                            ...
                            <div class="motivate">
                                ...
                                هر آزمون یک قدم به جلو – ادامه بده!
                            </div>
                            ...
                            @if ($isFinalAttempt)
                                <div class="done-alert">
                                    ...
                                    شما قبلاً در این آزمون شرکت کرده‌اید و امکان شرکت مجدد ندارید.
                                </div>
                            @endif
                        </div>
