...
@section('title', 'مدیریت ' . ($title ?? 'زیررشته‌ها'))
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="fw-bold mb-0">مدیریت {{ $title ?? 'زیررشته‌ها' }}</h3>
                ...
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="text-nowrap">
                            {!! sortLink('name_fa', 'نام زیررشته', $currentSort, $currentDir) !!}
                        </th>
                        ...
                        <th class="text-nowrap">نام زمینه</th>
