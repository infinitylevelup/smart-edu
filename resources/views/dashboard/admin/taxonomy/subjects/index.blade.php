...
@section('title', 'مدیریت ' . ($title ?? 'دروس'))
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="fw-bold mb-0">مدیریت {{ $title ?? 'دروس' }}</h3>
        ...
        <div class="card-body table-responsive">
            ...
            <table class="table table-bordered align-middle text-center mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="text-nowrap">
                            {!! sortLink('title_fa', 'نام درس', $currentSort, $currentDir) !!}
                        </th>
                        ...
                        <th class="text-nowrap">
                            {!! sortLink('code', 'کد درس', $currentSort, $currentDir) !!}
                        </th>

                        <th class="text-nowrap">مقطع</th>
                        <th class="text-nowrap">پایه</th>
                        <th class="text-nowrap">شاخه</th>
                        <th class="text-nowrap">زمینه</th>
                        <th class="text-nowrap">زیررشته</th>
                        <th class="text-nowrap">نوع درس</th>

                        <th class="text-nowrap">
                            {!! sortLink('sort_order', 'ترتیب', $currentSort, $currentDir) !!}
                        </th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="99" class="text-muted py-4">دیتایی وجود ندارد</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
